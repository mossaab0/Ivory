...
public class RetrievalEnvironment {
  ...
  public void initialize(boolean loadDoclengths) throws IOException, ConfigurationException {
    ...
    try {
      termidMap = new DefaultFrequencySortedDictionary(new Path(getIndexTermsData()), new Path(
          getIndexTermIdsData()), new Path(getIndexTermIdMappingData()), fs);
    } catch (Exception e) {
  ...
  public PostingsReader getPostingsReader(Expression exp) {
    ...
    try {
      if (exp.getType().equals(Expression.Type.OD)) {
        ...
        postingsReader = new ProximityPostingsReaderOrderedWindow(
            readers.toArray(new PostingsReader[0]), gapSize);
        ...
        postingsReader = new ProximityPostingsReaderUnorderedWindow(
            readers.toArray(new PostingsReader[0]), windowSize);
      } else {
  ...
  /**
   * Tokenizes text according to the tokenizer used to process the document collection. This
   * typically includes stopwords filtering, stemming, etc.
   * 
  ...
  /**
   * Returns file that contains the document length data. This file serves as input to
   * {@link DocLengthTable}, which provides random access to document lengths.
   */
  ...
  /**
   * Returns directory that contains the document length data. Data in this directory is compiled
   * into the denoted by {@link #getDoclengthsData()}.
   */
  ...
  /**
   * Returns directory that contains the {@link IntDocVector} representation of the collection.
   */
  ...
  /**
   * Returns file that contains an index into the {@link IntDocVector} representation of the
   * collection. This file serves as input to {@link IntDocVectorsForwardIndex}, which provides
   * random access to the document vectors.
   */
  ...
  /**
   * Returns directory that contains the {@link TermDocVector} representation of the collection.
   */
  ...
  /**
   * Returns file that contains an index into the {@link TermDocVector} representation of the
   * collection. This file serves as input to {@link TermDocVectorsForwardIndex}, which provides
   * random access to the document vectors.
   */
  ...
  /**
   * Returns file that contains the list of terms in the collection. The file consists of a stream
   * of bytes, read into an array, representing the terms, which are alphabetically sorted and
   * prefix-coded.
   */
  ...
  /**
   * Returns file that contains term ids sorted by the alphabetical order of terms. The file
   * consists of a stream of ints, read into an array. The array index position corresponds to
   * alphabetical sort order of the term. This is used to retrieve the term id of a term given its
  ...
  /**
   * Returns file that contains an index of term ids into the array of terms. The file consists of a
   * stream of ints, read into an array. The array index position corresponds to the term ids. This
   * is used to retrieve the index position into the {@link #getIndexTermsData()} file to map from
  ...
  /**
   * Returns file that contains a list of document frequencies sorted by the alphabetical order of
   * terms. The file consists of a stream of ints, read into an array. The array index position
   * corresponds to alphabetical sort order of the term. This is used to retrieve the df of a term
   * given its position in the {@link #getIndexTermsData()} data.
   */
  ...
  /**
   * Returns file that contains a list of document frequencies sorted by term id. The file consists
   * of a stream of ints, read into an array. The array index position corresponds to the term id.
   * Note that the term ids are assigned in descending order of document frequency. This is used to
  ...
  /**
   * Returns file that contains a list of collection frequencies sorted by the alphabetical order of
   * terms. The file consists of a stream of ints, read into an array. The array index position
   * corresponds to alphabetical sort order of the term. This is used to retrieve the cf of a term
   * given its position in the {@link #getIndexTermsData()} data.
   */
  ...
  /**
   * Returns file that contains a list of collection frequencies sorted by term id. The file
   * consists of a stream of ints, read into an array. The array index position corresponds to the
   * term id. This is used to retrieve the cf of a term given its term id.
   */
  ...
  /**
   * Returns file that contains an index into the postings. This file serves as input to
   * {@link IntPostingsForwardIndex}, which provides random access to postings lists.
   */
  ...
  public int readCollectionTermCount() {
    return FSProperty.readInt(fs, appendPath(indexPath, "property.CollectionTermCount"));
  }
  ...
  public long readCollectionLength() {
    return FSProperty.readLong(fs, appendPath(indexPath, "property.CollectionLength"));
  }

  public float readCollectionAverageDocumentLength() {
    return FSProperty.readFloat(fs,
        appendPath(indexPath, "property.CollectionAverageDocumentLength"));
  }
  ...
  public void writeCollectionTermCount(int cnt) {
    FSProperty.writeInt(fs, appendPath(indexPath, "property.CollectionTermCount"), cnt);
  }
  ...
  public void writeCollectionLength(long cnt) {
    FSProperty.writeLong(fs, appendPath(indexPath, "property.CollectionLength"), cnt);
  }

  public void writeCollectionAverageDocumentLength(float n) {
    FSProperty.writeFloat(fs, appendPath(indexPath, "property.CollectionAverageDocumentLength"), n);
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    RetrievalEnvironment env = new RetrievalEnvironment(indexPath,
